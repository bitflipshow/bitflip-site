...
**Adam**: I am just wondering how, how is this different than a typical Chasm deployment? Is it just going to be an interface type of change? Cause functionally that's, this is what Chasm has always been correct. It's a, it's a VDI play like that. Are they also, are they limited? Do you guys know, are they only Linux desktops?
*28:15*
...
**Geoff**: Hang on, now I want to pull up Arcasm Instance
*28:40*
...
**Alex**: well i think the big announce the big part of the announcement here to pay attention to is the fact that the the integration between chasm and proxmox there's now something called a chasm auto scaler
*29:22*
...
**Alex**: And I think this is doing a similar thing with Chasm natively integrating with Proxmox. It's not the same as the old pattern, like I say, where you just leave it spun up the whole time for the five minutes that you use it. This announcement is all about that kind of auto-scaling capability.
*29:56*
